package pe.edu.galaxy.training.java.api.reactive.webflux.controller;
...
public class TallerFunctionalConfig {
	...
	RouterFunction<ServerResponse> routers() {
		...
		})).and(route(DELETE("/talleres/{id}"), req -> {
